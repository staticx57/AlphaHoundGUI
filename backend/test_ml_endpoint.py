...
# Create a simple test spectrum with a peak around channel 400-420
# (simulating a ~662 keV Cs-137 peak if using standard calibration)
counts = np.zeros(1024)
# Add background
counts += np.random.poisson(10, 1024)
# Add a Gaussian peak
peak_center = 410
peak_width = 10
peak_height = 500
